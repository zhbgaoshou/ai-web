<template>
  <div class="navbar-end">
        ...
        >
          ...
          >
            ...
            >
              <successIcon
                width="16"
                v-show="key === settingStore.currentTheme"
              />
    ...
    <section>
      ...
      <div
        v-else
        class="avatar placeholder btn btn-sm btn-circle"
  ...
  <modal v-model:open="isOpenModal">
    <div class="flex items-center gap-2">
      <infoIcon width=" 15" /><span class="text-xs text-secondary"
        >注册时邮箱用来找回密码,可以不填</span
      >
    </div>
