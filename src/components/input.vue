<template>
    <form class="p-2 flex justify-center shadow-sm" @submit.prevent="submit">
        <div class="max-w-6xl w-[980px] bg-base-200 rounded-box p-2">
            <textarea @input="handleIn" @change="handleIn" @keydown="key" v-model.trim="textareaValue" ref="textareaEl"
                class="bg-transparent m-2 max-h-32 h-[24px] outline-none w-full resize-none p-0"
                placeholder="想问点什么..."></textarea>
